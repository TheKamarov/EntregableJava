...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        unDigitalHouseManager.altaCurso("Android",20002,35 );
        ...
        unDigitalHouseManager.inscribirAlumno(lectorDeArchivosCSV.leerYAgregarAlumnosDeUnCSV("C:\\Users\\Santy\\Desktop\\DigitalHouse\\Entregables\\PrimerEntregable\\SantiagoGonzalezFernandezAdicional\\CodigoSantiagoGonzalezFernandez\\listadoDeAlumnos.csv"),20002);
